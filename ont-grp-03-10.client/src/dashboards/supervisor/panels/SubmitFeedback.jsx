    ...
    <div className="panel">
      <div className="panel-header-row">
        <div>
          ...
          <p className="panel-section-sub">Provide your evaluation for PROP-0048.</p>
        </div>
      </div>

      <div className="detail-card">
        <div className="detail-card-header">
          <span className="mono">PROP-0048</span>
          <span className="status-chip" style={{ "--c": "#F59E0B" }}>Under Review</span>
        </div>
        <h4 className="detail-card-title">Digital Banking Adoption in Rural Areas</h4>
        <div className="detail-grid">
          <div><span className="detail-label">Student</span><span className="detail-value">S. Reddy</span></div>
          <div><span className="detail-label">Faculty</span><span className="detail-value">Engineering</span></div>
          <div><span className="detail-label">Supervisor</span><span className="detail-value">Dr. Mokoena</span></div>
