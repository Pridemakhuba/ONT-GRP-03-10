const students = [
  { id: "PG2024001", name: "M. Dlamini",  degree: "PhD",     year: 2, proposalStatus: "Approved", nextMilestone: "Annual Progress Report — 30 Jun 2025" },
  { id: "PG2025002", name: "T. Khumalo",  degree: "PhD",     year: 1, proposalStatus: "Under Review", nextMilestone: "Proposal Decision — Awaiting evaluator" },
  { id: "PG2024010", name: "R. Smith",    degree: "Masters", year: 2, proposalStatus: "Approved", nextMilestone: "Final Submission — 31 Aug 2025" },
];

const statusColor = { Approved: "#10B981", "Under Review": "#F59E0B", Pending: "#94A3B8" };
        ...
        {students.map((s) => (
          <div key={s.id} className="student-detail-card">
            ...
            <div className="student-detail-row">
              ...
              <span className="status-chip" style={{ "--c": statusColor[s.proposalStatus] }}>{s.proposalStatus}</span>
            </div>
