...
import type { UserRole, ADUser, ImportResults, ApiErrorResponse } from '../../types';
...
export default function ImportFromAD() {
  ...
  async function handleSearch(e: FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast.error(apiErr.response?.data?.message || 'AD search failed. Check LDAP configuration.');
  ...
  async function handleImport() {
    ...
    try {
      ...
      const apiErr = err as ApiErrorLike;
      toast.error(apiErr.response?.data?.message || 'Import failed');
