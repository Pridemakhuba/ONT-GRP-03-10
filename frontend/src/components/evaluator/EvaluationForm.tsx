...
export default function EvaluationForm() {
  ...
  const initScores: EvaluationScores = { clarityScore:0, literatureScore:0, methodologyScore:0, feasibilityScore:0,
  ...
  function setScore(key: keyof EvaluationScores, val: number) { setScores(p => ({ ...p, [key]: val })); }
        ...
        <div className="card mb-2">
          ...
          <div className="form-group">
            ...
            <div className="file-upload-zone" onClick={() => document.getElementById('evalDoc')?.click()}>
              ...
              <input id="evalDoc" type="file" accept=".pdf,.docx" style={{display:'none'}} onChange={e => setFile(e.target.files?.[0] ?? null)} />
            </div>
