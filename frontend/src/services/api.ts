...
export const proposalsApi = {
    ...
    resubmit: (id: number | string, formData: FormData): Promise<AxiosResponse<Proposal>> =>
        api.put(`/proposals/${id}/resubmit`, formData, { headers: { 'Content-Type': 'multipart/form-data' } }),
    getPendingEval: (): Promise<AxiosResponse<Proposal[]>> => api.get('/proposals/pending-evaluation'),
    getPendingAllocation: (): Promise<AxiosResponse<Proposal[]>> =>
        api.get('/proposals/pending-allocation'),
    getReadyForExamination: (): Promise<AxiosResponse<Proposal[]>> =>
        api.get('/proposals/ready-for-examination'),
    ...
    assignSupervisor: (
        id: number | string,
        data: { supervisorID: number }
    ): Promise<AxiosResponse<Proposal>> => api.put(`/proposals/${id}/assign-supervisor`, data),
    supervisorSignoff: (id: number | string): Promise<AxiosResponse<Proposal>> =>
        api.put(`/proposals/${id}/supervisor-signoff`),
    requestChanges: (
        id: number | string,
        data: { comments: string }
    ): Promise<AxiosResponse<Proposal>> => api.put(`/proposals/${id}/request-changes`, data),
    assignEvaluators: (
        id: number | string,
        data: { proposalID: number; evaluatorIDs: number[] }
    ): Promise<AxiosResponse<Proposal>> => api.post(`/proposals/${id}/assign-evaluators`, data),
    finalise: (id: number | string): Promise<AxiosResponse<Proposal>> =>
        api.put(`/proposals/${id}/finalise`),
};
...
export const progressReportsApi = {
    getAll: (): Promise<AxiosResponse<ProgressReport[]>> => api.get('/progress-reports'),
    submit: (data: CreateProgressReport): Promise<AxiosResponse<ProgressReport>> =>
